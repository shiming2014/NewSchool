...
public class ClassmateNotHomeworkAdapter extends RecyclerView.Adapter<ClassmateNotHomeworkAdapter.ViewHolder> {
    private List<StudentInfo> studentInfos;
    private Context context;

    public ClassmateNotHomeworkAdapter(List<StudentInfo> studentInfos) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_homework_notpublish, parent, false);
        final ClassmateNotHomeworkAdapter.ViewHolder holder = new ClassmateNotHomeworkAdapter.ViewHolder(view);
    ...
    private void sendEmial(String emailTo, String emailFrom, String stuName) {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, stuName + "--作业提交提醒--"); // 主题
        intent.putExtra(Intent.EXTRA_TEXT, "您有作业未提交，请及时查看作业说明并提交"); // 正文
